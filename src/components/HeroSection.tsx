  ...
  return (
    <div className="relative group flex flex-col items-center">
      ...
      <div
        ...
        style={{ width: "min(220px, 48vw)", height: "min(220px, 48vw)" }}
      >
        <motion.div
          ...
          style={{
            background:
              rotateDir > 0
                ? "conic-gradient(from 0deg, #B36D00, #FFAA00, #FFD047, #FFAA00, #B36D00)"
                : "conic-gradient(from 180deg, #B36D00, #FFAA00, #FFD047, #FFAA00, #B36D00)",
            padding: "2px",
            borderRadius: "9999px",
          }}
          animate={{ rotate: rotateDir > 0 ? 360 : -360 }}
        ...
        >
          {!imgError ? (
            ...
            /* Placeholder shown only when image truly fails */
            <div
      ...
      {/* Name labels */}
      <p
        className="text-center mt-5 font-cinzel text-sm tracking-widest"
        style={{ color: "rgba(255,170,0,0.85)" }}
      >
        {label}
      </p>
      <p
        className="text-center font-cormorant italic text-sm"
        style={{
...
export default function HeroSection() {
  ...
  return (
    <section
      ...
      style={{
        background:
          "radial-gradient(ellipse at top center, #2D0D5C 0%, #1A0535 20%, #0C0318 60%, #040108 100%)",
      }}
    >
      {/* Floating petals */}
      {petals.map((petal) => (
      ...
      >
        ...
        >
          ...
          <p
            className="font-cormorant italic text-sm mt-2"
            style={{
        ...
        >
          <h1
            ...
            style={{
              ...
              background:
                "linear-gradient(135deg, #B36D00 0%, #FFAA00 40%, #FFD047 60%, #FFAA00 100%)",
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(90deg, transparent, rgba(255,170,0,0.6))",
              }}
            />
            <span
        ...
        >
          ...
          >
            <svg width="56" height="56" viewBox="0 0 60 60">
              ...
              <path
                d="M30 50 C30 50 5 35 5 20 C5 12 12 5 20 5 C24 5 28 7 30 10 C32 7 36 5 40 5 C48 5 55 12 55 20 C55 35 30 50 30 50Z"
                fill="url(#heartGrad)"
                opacity="0.85"
              />
            </svg>
        ...
        >
          <div className="ornament-line max-w-md mx-auto mb-4">
            <span
              className="font-cinzel text-xs tracking-[0.4em]"
